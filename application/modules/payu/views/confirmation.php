                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo $action; ?>/_payment" method="post" id="payuForm" name="payuForm">
                                ...
                                <input name="studentid" value="<?php echo $customerid; ?>" type="hidden" />
                                 <input name="discount" value="<?php echo $discount; ?>" type="hidden" />
                                  <input name="amountactual" value="<?php echo $amountactual; ?>" type="hidden" />
                                <div class="form-group">
