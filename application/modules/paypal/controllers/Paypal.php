...
class Paypal extends MX_Controller {
    ...
    function __construct() {
        ...
        $pgateway = $this->pgateway_model->getGatewayById('1');
        ...
        $config = array(
            ...
            'APIUsername' => $pgateway->username, // PayPal API username of the API caller
            'APIPassword' => $pgateway->password, // PayPal API password of the API caller
            'APISignature' => $pgateway->signature, // PayPal API signature of the API caller
    ...
    function Do_direct_payment($all_details) {
        ...
        $PayerInfo = array(
            'email' => $all_details['customer_email'], // Email address of payer.
        ...
        $PayerName = array(
            ...
            'firstname' => $all_details['customer_name'], // Payer's first name.  25 char max.
        ...
        $BillingAddress = array(
            ...
            'phonenum' => $all_details['customer_phone']       // Phone Number of payer.  20 char max.
        );
        ...
        if (!$this->paypal_pro->APICallSuccessful($PayPalResult['ACK'])) {
            ...
            /*
              ...
              $data = array('customer' => $all_details['customer'],
              'date' => time(),
              ...
              redirect('finance/customerPaymentHistory?customer=' . $all_details['customer']);
              }
